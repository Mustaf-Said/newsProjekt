...
export default function ListingCard({ listing, type, index, isFavorite, onToggleFavorite }) {
  const detailPage = type === "car" ? "ListingDetail" : type === "house" ? "ListingDetail" : "ListingDetail";
  ...
  return (
    ...
    >
      <Link to={createPageUrl(`ListingDetail?type=${type}&id=${listing.id}`)}>
