...
import { Trophy, Filter, Circle, Loader2, RefreshCw } from "lucide-react";
  ...
  const fetchScores = async () => {
    ...
    try {
      const res = await base44.integrations.Core.InvokeLLM({
        prompt: "Give me 15 football (soccer) match results and live matches from today or the most recent match day. Include matches from Premier League, La Liga, Bundesliga, Serie A, Champions League. For each: home_team, away_team, home_score, away_score, league, status (LIVE/FT/Upcoming), minute or time, and stadium.",
