  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-8">
      ...
      <div className="text-center py-20">
        <LayoutDashboard className="w-16 h-16 mx-auto text-[var(--text-secondary)] opacity-30 mb-4" />
        <p className="text-lg font-semibold text-[var(--text-secondary)]">Dashboard temporarily unavailable</p>
